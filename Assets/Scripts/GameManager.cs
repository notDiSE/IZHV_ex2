...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (sGameStarted && !mGameLost)
        {
            ...
            GetChildNamed(scoreText, "Value").GetComponent<Text>().text = $"{(int)(mCurrentScore)}"; // neoptimalizovane porad ziskavat komponentu v updatu ale nebudu to menit
            finalScoreText.GetComponent<Text>().text = $"Score: {(int)(mCurrentScore)}";
        } 
    }
